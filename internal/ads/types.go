...
type Metrics struct {
	...
	LandingPageViews   *int64           `json:"landing_page_views,omitempty"`
	VideoViews2s       *int64           `json:"video_views_2s,omitempty"`
	VideoViews6s       *int64           `json:"video_views_6s,omitempty"`
	VideoViewsComplete *int64           `json:"video_views_complete,omitempty"`
}

func ZeroMetrics() Metrics {
	z := decimal.Zero
	n := int64(0)
	return Metrics{Conversions: &z, Revenue: &z, Reach: &n, LandingPageViews: &n, VideoViews2s: &n, VideoViews6s: &n, VideoViewsComplete: &n}
}
func (m Metrics) Add(n Metrics) Metrics {
	...
	// Reach is non-additive across time and objects; aggregated totals must not
	// pretend summed daily reach is unique reach.
	m.Reach = nil
	m.LandingPageViews = addOptionalInt(m.LandingPageViews, n.LandingPageViews)
	m.VideoViews2s = addOptionalInt(m.VideoViews2s, n.VideoViews2s)
	m.VideoViews6s = addOptionalInt(m.VideoViews6s, n.VideoViews6s)
	m.VideoViewsComplete = addOptionalInt(m.VideoViewsComplete, n.VideoViewsComplete)
	return m
}
func addOptionalInt(a, b *int64) *int64 {
	if a == nil || b == nil {
		return nil
	}
	v := *a + *b
