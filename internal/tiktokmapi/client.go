...
func NewClient(cfg Config) (*Client, error) {
	...
	return &Client{base: base, advertiserID: cfg.AdvertiserID, environment: cfg.Environment, http: &copyClient, tokens: cfg.Tokens, maxPages: cfg.MaxPages, revenueMetric: cfg.RevenueMetric}, nil
}
