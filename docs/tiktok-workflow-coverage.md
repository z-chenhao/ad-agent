...
| Budget operations                | Active | Review pacing and draft a bounded budget change                              | Campaign and Adgroup update; Reporting            | One-object staged budget                               |
| Delivery operations              | Active | Investigate and draft enable/disable                                         | Campaign, Adgroup, and Ad status update           | One-object staged status                               |
...
| Change governance                | Active | Review, discard, or reconcile drafts                                         | Campaign, Adgroup, and Ad update families         | Host-owned ledger and approval                         |
